	...
	for(i in 1:length(nc_lat))	{
		for(j in 1:length(nc_lon))	{
			...
			if(any(!is.na(nc_dummy) & any(nc_dummy != missing_data)))	{
				...
				datesSeq1019 = rep(seq(first(dates10s), last(dates10s), 12), 4)
				datesSeq2029 = rep(seq(first(dates20s), last(dates20s), 12), 4)
				datesSeq3039 = rep(seq(first(dates30s), last(dates30s), 12), 4)
				datesSeq4049 = rep(seq(first(dates40s), last(dates40s), 12), 4)
				datesSeq5059 = rep(seq(first(dates50s), last(dates50s), 12), 4)
				datesSeq6069 = rep(seq(first(dates60s), last(dates60s), 12), 4)
				datesSeq7079 = rep(seq(first(dates70s), last(dates70s), 12), 4)
				datesSeq8089 = rep(seq(first(dates80s), last(dates80s), 12), 4)
				datesSeq9099 = rep(seq(first(dates90s), last(dates90s), 12), 4)
...
myNC = nc_open(paste0(ncpath, 'floodRecurIntervals_v4.nc'))
