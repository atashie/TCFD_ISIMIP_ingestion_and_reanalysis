...
ncpath = "J:\\Cai_data\\TCFD\\SoyRainfed\\"
	# reading ssp126 climate data 
ncname_gfdl = 'clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_yield-soy-noirr_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_gfdl = nc_open(paste0(ncpath, ncname_gfdl))
nc_gfdl = ncvar_get(ncin_gfdl,"pft-mai-rainfed")	# lon, lat, time

ncname_hadgem = 'clm45_hadgem2-es_ewembi_rcp60_2005soc_co2_yield-soy-noirr_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_hadgem = nc_open(paste0(ncpath, ncname_hadgem))
nc_hadgem = ncvar_get(ncin_hadgem,"pft-mai-rainfed")	# lon, lat, time

ncname_ipsl = 'clm45_ipsl-cm5a-lr_ewembi_rcp60_2005soc_co2_yield-soy-noirr_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_ipsl = nc_open(paste0(ncpath, ncname_ipsl))
nc_ipsl = ncvar_get(ncin_ipsl,"pft-mai-rainfed")	# lon, lat, time

ncname_miroc = 'clm45_miroc5_ewembi_rcp60_2005soc_co2_yield-soy-noirr_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
...
all_data$Hazard = "Soy Productivity (unirrigated)"
