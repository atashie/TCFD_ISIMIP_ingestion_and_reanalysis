...
all_data = fread(paste0(ncpath, ncVarFileName, "_", "allData_", saveDate, ".csv"), colClasses=c('numeric','numeric','character','character','characte','numeric','numeric'))
...
thisdecade = subset(all_data, Decade == '2060s' & Scenario == 'rcp26')# & Lon < -10 & Lon > -100)
