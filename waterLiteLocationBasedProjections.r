...
hydroVariables = data.frame(varLoc = 		c('GWstorage', 		'RootZoneSoilMoisture', 'GWrecharge',	'SurfaceWater_Streamflow',	'Evapotranspiration'),
							varFileName = 	c('groundwstor',	'rootmoist', 			'qr',		 	'dis', 						'evap'),
							model = 		c('watergap2-2c',	'clm45',				'watergap2-2c',	'matsiro',				'clm45'),
							commonName = 	c('Groundwater (mm)','Soil Moisture (mm)',	'Recharge (mm)','Streamflow (%)',			'ET Demand (mm)'))	
