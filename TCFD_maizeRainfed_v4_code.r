...
ncname_dummy = paste0('lpjml_gfdl-esm2m_ewembi_rcp26_2005soc_co2_', ncVarFileName, '_global_annual_2006_2099.nc4')#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
...
metadata = list(tcfdVariable = list(units = 'Maize Yield (nonirrigated) - tons / ha / yr'))
